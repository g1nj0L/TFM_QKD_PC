...
CSV.write("SSPvsBB84v2_18-03/epsilon_0/data/BB84_depolarized_data_e0.csv", df_export)
println()
println("BB84 data successfully saved into 'BB84_depolarized_data_e0.csv'!")